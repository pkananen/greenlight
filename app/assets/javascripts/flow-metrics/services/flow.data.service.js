(function() {
    ...
    function FlowDataFactory() {
      ...
      function getItems() {
        return [
          {name: "W101", id: 1, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 2, value: 100},
          {name: "W102", id: 2, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), value: 100},
          {name: "W103", id: 3, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), value: 50},
          {name: "W104", id: 4, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 2, value: 100},
          {name: "W105", id: 5, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 2, value: 0},
          {name: "W106", id: 6, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 2, value: 0},
          {name: "W107", id: 7, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), value: 50},
          {name: "W108", id: 8, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 1, value: 0},
          {name: "W109", id: 9, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 1, value: 300},
          {name: "W110", id: 10, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 1, value: 0},
          {name: "W111", id: 11, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 1, value: 40},
          {name: "W112", id: 12, columnId: 1, workerId: undefined, timestamp: 0, times: {active: 0, idle: 0}, workRemaining: _.sample([5, 7, 11, 17]), batchId: 5, value: 0},
